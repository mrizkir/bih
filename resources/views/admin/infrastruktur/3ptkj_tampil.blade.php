                        ...
                        <section style="padding:20px;background:rgb(255, 255, 255);">
                            ...
                            <div style="margin:10px;">
                                <div class="border-0">
                                    ...
                                    <a href="{{ route('ptkjcetak') }}" target="_blank">
                                        ...
                                        @foreach ($data as $k => $item)
                                            <tr style="font-size: 11px;">
                                                ...
                                                <td><strong>Tahun</strong> : {{ $item->tahun }} | 
                                                    ...
                                                    <strong>kemantapan_jalan </strong> : {{ $item->kemantapan_jalan }} %
                                                </td>
                                                <td class="project-actions text-center" style="padding: 10px;">
                                                    ...
                                                    {{-- <a href="{{ 'ptkjdel/'.$item->tahun }}" class="btn btn-info btn-sm"  
                                                                ...
                                                                <div class="container" style="padding:30px;">
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            <div class="col-12"> 
                                                                                {!! Form::open([
                                                                                    'url' => route('infrastruktur-ptkj.update', ['id' => $item->tahun]),
                                                                                    'method' => 'put',
                                                                                ...
                                                                                <div class="card-body">
                                                                                    <div class="form-group">
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-4">
                                                                                                <label>Data
                                                                                                    Kemantapan Jalan</label>
                                                                                                <input type="text"
                                                                                                    name="kemantapan_jalan"
                                                                                                    class="form-control @error('kemantapan_jalan') is-invalid @enderror"
                                                                                                    value="{{ $item->kemantapan_jalan }}"
                                                                                                    required>
                                                                                                @if ($errors->has('kemantapan_jalan'))
                                                                                                    <div class="alert alert-danger mt-1 alert-validation-msg"
                                                                                                        role="alert">
                                                                                                        <div
                                                                                                            class="alert-body d-flex align-items-center">
                ...
                <div class="modal fade" id="modal-default">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            ...
                            {!! Form::open(['url' => route('infrastruktur-ptkj.store'), 'method' => 'post', 'id' => 'frmadd', 'name' => 'frmadd']) !!}
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-4">
                                        ...
                                        <div class="col-4">
                                            <label>Data Kemantapan Jalan</label>
                                            <input type="text" name="kemantapan_jalan"
                                                class="form-control @error('kemantapan_jalan') is-invalid @enderror"
                                                placeholder="Ketik Data kemantapan_jalan" required>
                                            @if ($errors->has('kemantapan_jalan'))
                                                <div class="alert alert-danger mt-1 alert-validation-msg" role="alert">
                                                    <div class="alert-body d-flex align-items-center">
                                                        <i data-feather="info" class="me-50"></i>
