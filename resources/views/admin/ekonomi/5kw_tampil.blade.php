                        ...
                        <section style="padding:20px;background:rgb(255, 255, 255);">
                            ...
                            <div style="margin:10px;">
                                <div class="border-0">
                                    ...
                                    <a href="{{ route('kwcetak') }}" target="_blank">
                                        ...
                                        @foreach ($data as $k => $item)
                                            <tr style="font-size: 11px;">
                                                ...
                                                <td><strong>Tahun</strong> : {{ $item->tahun }} |
                                                    ...
                                                    <strong> Mancanegara</strong> : {{ $item->mancanegara }} |
                                                    <strong> Nusantara</strong> : {{ $item->nusantara }} |
                                                ...
                                                <td class="project-actions text-center" style="padding: 10px;">
                                                    ...
                                                    {{-- <a href="{{ 'kwdel/'.$item->tahun }}" class="btn btn-info btn-sm"  
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="row">
                                                                                            <div class="col-3">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                    name="mancanegara"
                                                                                                    class="form-control @error('mancanegara') is-invalid @enderror"
                                                                                                    value="{{ $item->mancanegara }}"
                                                                                                    required>
                                                                                                @if ($errors->has('mancanegara'))
                                                                                                    <div class="alert alert-danger mt-1 alert-validation-msg"
                                                                                                        role="alert">
                                                                                                        <div
                                                                                                            class="alert-body d-flex align-items-center">
                                                                                            ...
                                                                                            <div class="col-3">
                                                                                              ...
                                                                                              <input type="text"
                                                                                                  name="nusantara"
                                                                                                  class="form-control @error('nusantara') is-invalid @enderror"
                                                                                                  value="{{ $item->nusantara }}"
                                                                                                  required>
                                                                                              @if ($errors->has('nusantara'))
                                                                                                  <div class="alert alert-danger mt-1 alert-validation-msg"
                                                                                                      role="alert">
                                                                                                      <div
                                                                                                          class="alert-body d-flex align-items-center">
                ...
                <div class="modal fade" id="modal-default">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            ...
                            {!! Form::open(['url' => route('ekonomi-kw.store'), 'method' => 'post', 'id' => 'frmadd', 'name' => 'frmadd']) !!}
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-3">
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <label>Data Mancanegara</label>
                                            <input type="text" name="mancanegara"
                                                class="form-control @error('mancanegara') is-invalid @enderror"
                                                placeholder="Ketik Data mancanegara" required>
                                            @if ($errors->has('mancanegara'))
                                                <div class="alert alert-danger mt-1 alert-validation-msg" role="alert">
                                                    <div class="alert-body d-flex align-items-center">
                                                        <i data-feather="info" class="me-50"></i>
                                        ...
                                        <div class="col-3">
                                            <label>Data Nusantara</label>
                                            <input type="text" name="nusantara"
                                                class="form-control @error('nusantara') is-invalid @enderror"
                                                placeholder="Ketik Data nusantara" required>
                                            @if ($errors->has('nusantara'))
                                                <div class="alert alert-danger mt-1 alert-validation-msg" role="alert">
                                                    <div class="alert-body d-flex align-items-center">
                                                        <i data-feather="info" class="me-50"></i>
