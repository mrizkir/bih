                        ...
                        <section style="padding:20px;background:rgb(255, 255, 255);">
                            ...
                            <div style="margin:10px;">
                                <div class="border-0">
                                    ...
                                    <a href="{{ route('adhk_ocetak') }}" target="_blank">
                                        ...
                                        @foreach ($data as $k => $item)
                                            <tr style="font-size: 11px;">
                                                ...
                                                <td class="project-actions text-center" style="padding: 10px;">
                                                    ...
                                                    {{-- <a href="{{ 'adhb_odel/'.$item->tahun }}" class="btn btn-info btn-sm"  
                                                                ...
                                                                <div class="container" style="padding:30px;">
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            <div class="col-12"> 
                                                                                {!! Form::open([
                                                                                    'url' => route('ekonomi-adhk_O.update', ['id' => $item->tahun]),
                                                                                    'method' => 'put',
                ...
                <div class="modal fade" id="modal-default">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            ...
                            {!! Form::open(['url' => route('ekonomi-adhk_O.store'), 'method' => 'post', 'id' => 'frmadd', 'name' => 'frmadd']) !!}
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-4">
