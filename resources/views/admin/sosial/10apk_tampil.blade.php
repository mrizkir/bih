        ...
        <div class="row">
          <div class="col-md-12">
            <section style="padding:20px;background:rgb(255, 255, 255);">
              <div class="row mb-2">
                <div class="col-sm-6">
                  <li class="breadcrumb-item active" style="font-size: 25px;"><strong>{{ $title }}</strong></li>
                </div> 
                <div class="col-sm-6">
                </div>
              </div> 
              <div class="row mb-2">
              <h4 style="padding:20px;font-size: 20px;">SD 7-12 Tahun</h4>
              </div> 
...
<BR><BR>
              ...
              <div class="row mb-2">
                <h4 style="padding:20px;font-size: 20px;">SMP 13-15 Tahun</h4>
                </div> 
                <div style="margin:10px;">
                  <div class="border-0">
                    @include('layouts.pesan')
