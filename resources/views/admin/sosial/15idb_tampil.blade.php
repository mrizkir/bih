                        ...
                        <section style="padding:20px;background:rgb(255, 255, 255);">
                            ...
                            <div style="margin:10px;">
                                <div class="border-0">
                                    ...
                                    <a href="{{ route('idbcetak') }}" target="_blank">
                                        ...
                                        @foreach ($data as $k => $item)
                                            <tr style="font-size: 11px;">
                                                ...
                                                <td><strong>Tahun</strong> : {{ $item->tahun }} | <strong>Series</strong> :
                                                    ...
                                                    <strong>Indeks Daya Beli</strong> : {{ $item->daya_beli }}</td>
                                                                                ...
                                                                                <div class="card-body">
                                                                                    <div class="form-group">
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-4">
                                                                                                <label>Daya Beli</label>
                                                                                                <input type="text"
                                                                                                    name="daya_beli"
                                                                                                    class="form-control @error('daya_beli') is-invalid @enderror"
                                                                                                    value="{{ $item->daya_beli }}"
                                                                                                    required>
                                                                                                @if ($errors->has('daya_beli'))
                                                                                                    <div class="alert alert-danger mt-1 alert-validation-msg"
                                                                                                        role="alert">
                                                                                                        <div
                                                                                                            class="alert-body d-flex align-items-center">
                ...
                <div class="modal fade" id="modal-default">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            ...
                            {!! Form::open(['url' => route('sosial-idb.store'), 'method' => 'post', 'id' => 'frmadd', 'name' => 'frmadd']) !!}
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-4">
                                        ...
                                        <div class="col-4">
                                            <label>Data Daya Beli </label>
                                            <input type="text" name="daya_beli"
                                                class="form-control @error('daya_beli') is-invalid @enderror"
                                                placeholder="Ketik Data daya_beli" required>
                                            @if ($errors->has('daya_beli'))
                                                <div class="alert alert-danger mt-1 alert-validation-msg" role="alert">
                                                    <div class="alert-body d-flex align-items-center">
                                                        <i data-feather="info" class="me-50"></i>
