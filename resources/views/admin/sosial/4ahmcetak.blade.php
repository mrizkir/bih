        ...
        <table class="table">
            ...
            <thead style="background: rgb(4, 101, 127);color:aliceblue;">
                <tr style="font-size:12px;">
                    ...
                    <th style="width: 20%;"><center>Kelompok Umur</center></th> 
                    <th style="width: 27%;"> Laki-laki</th>
                    <th style="width: 27%;"> Perempuan</th>
                    <th style="width: 31%;">Data Series</th>
                </tr>
            </thead>
            <tbody>
                @foreach ($data as $k => $item)
                    <tr style="font-size:10px;">
                        ...
                        <td><center>{{ $item->kel_umur }}</center></td>
