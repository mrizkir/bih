                                        ...
                                        @foreach ($data as $k => $item)
                                            <tr style="font-size: 11px;">
                                                ...
                                                <td class="project-actions text-center" style="padding: 10px;">
                                                    ...
                                                    {{-- VIEW MODAL EDIT --}}
                                                    <div class="modal fade" id="modaledit{{ $item->no }}"
                                                        role="dialog">
                ...
                <div class="modal fade" id="modal-default">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            ...
                            {!! Form::open(['url' => route('sosial-ppu.store'), 'method' => 'post', 'id' => 'frmadd', 'name' => 'frmadd']) !!}
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-4">
                                            ...
                                            <input type="text" name="pendidikan"
                                                class="form-control @error('pendidikan') is-invalid @enderror"
                                                placeholder="Ketik pendidikan" required>
                                            @if ($errors->has('pendidikan'))
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <input type="text" name="total"
                                                class="form-control @error('total') is-invalid @enderror"
                                                placeholder="Ketik Data Total" required>
                                            @if ($errors->has('total'))
                                                <div class="alert alert-danger mt-1 alert-validation-msg" role="alert">
                                                    <div class="alert-body d-flex align-items-center">
                                                        <i data-feather="info" class="me-50"></i>
