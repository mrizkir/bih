                        ...
                        <section style="padding:20px;background:rgb(255, 255, 255);">
                            ...
                            <div style="margin:10px;">
                                <div class="border-0">
                                    ...
                                    <a href="{{ route('ahmcetak') }}" target="_blank">
                                    ...
                                    <tbody>
                                        @foreach ($data as $k => $item)
                                            <tr style="font-size: 11px;">
                                                ...
                                                <td><strong>Kelompok Umur</strong> : {{ $item->kel_umur }} | <strong>Series</strong> :
                                                ...
                                                <td class="project-actions text-center" style="padding: 10px;">
                                                    ...
                                                    {{-- <a href="{{ 'ahmdel/'.$item->kel_umur }}" class="btn btn-info btn-sm"  
