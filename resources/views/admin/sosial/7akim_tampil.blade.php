                        ...
                        <section style="padding:20px;background:rgb(255, 255, 255);">
                            ...
                            <div style="margin:10px;">
                                <div class="border-0">
                                    ...
                                    <a href="{{ route('akimcetak') }}" target="_blank">
                                        ...
                                        @foreach ($data as $k => $item)
                                            <tr style="font-size: 11px;">
                                                ...
                                                <td><strong>Tahun</strong> : {{ $item->tahun }} | 
                                                    ...
                                                    <strong>Data Angka Kematian Ibu </strong> : {{ $item->kematian_ibu }}</td>
                                                <td class="project-actions text-center" style="padding: 10px;">
                                                    ...
                                                    {{-- <a href="{{ 'akimdel/'.$item->tahun }}" class="btn btn-info btn-sm"  
                                                                    ...
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            <div class="col-12">
                                                                             <BR>
                                                                                {!! Form::open([
                                                                                    'url' => route('sosial-akim.update', ['id' => $item->tahun]),
                                                                                    'method' => 'put',
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-4">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                    name="kematian_ibu"
                                                                                                    class="form-control @error('kematian_ibu') is-invalid @enderror"
                                                                                                    value="{{ $item->kematian_ibu }}"
                                                                                                    required>
                                                                                                @if ($errors->has('kematian_ibu'))
                                                                                                    <div class="alert alert-danger mt-1 alert-validation-msg"
                                                                                                        role="alert">
                                                                                                        <div
                                                                                                            class="alert-body d-flex align-items-center">
                ...
                <div class="modal fade" id="modal-default">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            ...
                            {!! Form::open(['url' => route('sosial-akim.store'), 'method' => 'post', 'id' => 'frmadd', 'name' => 'frmadd']) !!}
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-4">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <input type="text" name="kematian_ibu"
                                                class="form-control @error('kematian_ibu') is-invalid @enderror"
                                                placeholder="Ketik Data Kematian Ibu" required>
                                            @if ($errors->has('kematian_ibu'))
                                                <div class="alert alert-danger mt-1 alert-validation-msg" role="alert">
                                                    <div class="alert-body d-flex align-items-center">
                                                        <i data-feather="info" class="me-50"></i>
