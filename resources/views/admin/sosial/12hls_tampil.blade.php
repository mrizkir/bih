                        ...
                        <section style="padding:20px;background:rgb(255, 255, 255);">
                            ...
                            <div style="margin:10px;">
                                <div class="border-0">
                                    ...
                                    <a href="{{ route('hlscetak') }}" target="_blank">
                                        ...
                                        @foreach ($data as $k => $item)
                                            <tr style="font-size: 11px;">
                                                ...
                                                <td><strong>Tahun</strong> : {{ $item->tahun }} | <strong>Series</strong> :
                                                    ...
                                                    <strong>Presentase</strong> : {{ $item->hls }}</td>
                                                <td class="project-actions text-center" style="padding: 10px;">
                                                    ...
                                                    {{-- <a href="{{ 'hlsdel/'.$item->tahun }}" class="btn btn-info btn-sm"  
                                                                ...
                                                                <div class="container" style="padding:30px;">
                                                                    <div class="form-group">
                                                                        <div class="row">
                                                                            <div class="col-12"> 
                                                                                {!! Form::open([
                                                                                    'url' => route('sosial-hls.update', ['id' => $item->tahun]),
                                                                                    'method' => 'put',
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="col-4">
                                                                                                ...
                                                                                                <input type="text"
                                                                                                    name="hls"
                                                                                                    class="form-control @error('hls') is-invalid @enderror"
                                                                                                    value="{{ $item->hls }}"
                                                                                                    required>
                                                                                                @if ($errors->has('hls'))
                                                                                                    <div class="alert alert-danger mt-1 alert-validation-msg"
                ...
                <div class="modal fade" id="modal-default">
                    <div class="modal-dialog modal-xl">
                        <div class="modal-content">
                            ...
                            {!! Form::open(['url' => route('sosial-hls.store'), 'method' => 'post', 'id' => 'frmadd', 'name' => 'frmadd']) !!}
                            <div class="card-body">
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-4">
                                        ...
                                        <div class="col-4">
                                            <label>Data hls </label>
                                            <input type="text" name="hls"
                                                class="form-control @error('hls') is-invalid @enderror"
                                                placeholder="Ketik Data hls" required>
                                            @if ($errors->has('hls'))
                                                <div class="alert alert-danger mt-1 alert-validation-msg" role="alert">
                                                    <div class="alert-body d-flex align-items-center">
                                                        <i data-feather="info" class="me-50"></i>
